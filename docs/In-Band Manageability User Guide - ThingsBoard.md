...
'security' - Security |It will provide the information of1.whether DM verity is enabled or not2.whether Measured Boot is enabled or not3.whether HDDL plug-in card is provisioned or not 4.whether using Secured Xlink or not
